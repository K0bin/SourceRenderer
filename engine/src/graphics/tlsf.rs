...
impl<'pool, T, FLBitmap: BinInteger, SLBitmap: BinInteger, const FLLEN: usize, const SLLEN: usize>
    Tlsf<'pool, T, FLBitmap, SLBitmap, FLLEN, SLLEN>
{
    ...
    /// This method never panics.
    #[inline]
    pub fn insert_free_block(&mut self, block: &'pool mut T) -> impl Send + Sync {
