...
pub fn install<P: Platform>(
    ...
    world.push((
        Transform::new(Vec3::new(0f32, -2f32, -5f32)),
        RigidBodyComponent {
    ...
    let camera = world.push((
        ...
        Transform::new(Vec3::new(0.0f32, 1.0f32, -1.0f32)),
...
fn spin(transform: &mut Transform, #[resource] delta_time: &DeltaTime) {
    transform.rotation *= Quaternion::from_axis_angle(
        &Unit::new_unchecked(Vec3::new(0.0f32, 1.0f32, 0.0f32)),
        1.0f32 * delta_time.secs(),
    );
}
...
fn place_lights(
    ...
    #[state] state: &mut PlaceLightsState,
