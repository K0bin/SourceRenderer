...
pub trait Device<B: Backend> {
  ...
  fn create_texture_view(&self, texture: &Arc<B::Texture>, info: &TextureViewInfo, name: Option<&str>) -> Arc<B::TextureView>;
  ...
  fn insert_texture_into_bindless_heap(&self, texture: &Arc<B::TextureView>) -> u32;
