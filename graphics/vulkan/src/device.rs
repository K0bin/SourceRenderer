...
impl VkDevice {
    pub fn new(
        ...
        let context = Arc::new(VkThreadManager::new(
            &raw,
            &graphics_queue_info,
            compute_queue_info.as_ref(),
            transfer_queue_info.as_ref(),
            &shared,
            min(3, max_surface_image_count),
        ));
...
impl Device<VkBackend> for VkDevice {
    ...
    fn create_compute_pipeline(
        ...
        Arc::new(VkPipeline::new_compute(
            &self.device,
            shader,
            self.context.shared(),
            name,
    ...
    fn create_graphics_pipeline(
        ...
        subpass: u32,
        name: Option<&str>,
    ) -> Arc<<VkBackend as Backend>::GraphicsPipeline> {
        ...
        Arc::new(VkPipeline::new_graphics(
            &self.device,
            &vk_info,
            shared,
            name,
    ...
    fn init_texture(
        ...
        self.transfer
            .init_texture(texture, buffer, mip_level, array_layer, buffer_offset);
    }

    fn init_texture_async(
        &self,
        texture: &Arc<VkTexture>,
        buffer: &Arc<VkBufferSlice>,
        mip_level: u32,
    ...
    fn init_buffer(
        ...
        self.transfer
            .init_buffer(src_buffer, dst_buffer, src_offset, dst_offset, length);
    }
    ...
    fn insert_texture_into_bindless_heap(&self, texture: &Arc<VkTextureView>) -> u32 {
        let bindless_set = self
            ...
            .expect("Descriptor indexing is not supported on this device.");
    ...
    fn create_raytracing_pipeline(
        ...
        Arc::new(VkPipeline::new_ray_tracing(
            &self.device,
            info,
            &self.shared,
        ))
