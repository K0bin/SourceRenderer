use crate::lump_data::{brush::BrushContents, LumpData, LumpType};
...
impl LumpData for Leaf {
    ...
    fn read(reader: &mut dyn Read, version: i32) -> IOResult<Self> {
        ...
        let mins: [i16; 3] = [reader.read_i16()?, reader.read_i16()?, reader.read_i16()?];

        let maxs: [i16; 3] = [reader.read_i16()?, reader.read_i16()?, reader.read_i16()?];
