...
use crate::image_format::{calculate_image_size, is_image_format_supported};
use crate::thumbnail::Thumbnail;
use crate::Frame;
use crate::{Face, MipMap, Slice};
...
impl<R: Read + Seek> VtfTexture<R> {
    ...
    pub fn new(mut reader: R) -> IOResult<Self> {
        ...
        let thumbnail = resource_offsets
    ...
    fn calculate_mip_offset(&self, level: u32) -> Option<u64> {
        ...
        for level in 0..level {
            ...
            let level_image_size = calculate_image_size(
                level_width,
                level_height,
                1,
